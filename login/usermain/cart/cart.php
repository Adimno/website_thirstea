			...
			?>
                ...
                <div class="col-md-4 summary">
                    ...
                    <form method="post" action="">
                        <p>PAYMENT</p>
                        <select id="payment_method" name="payment_method"><option class="text-muted" value="COD">CASH-ON-DELIVERY- &#8369;FREE</option>
						<?php
   ...
   $email = $_SESSION['email'];
            ...
            $result = $conn->query($query);
			 ...
			 if ($result && $row = $result->fetch_assoc()) {
                ...
                if (!empty($creditCard)) {
                    echo '<option class="text-muted" value="E-WALLET">E-WALLET- &#8369;FREE</option>';
                }
            }
